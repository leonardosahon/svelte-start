...
<div>
	...
	<div class="relative">
		<div class="bg-muted rounded-br-lg rounded-bl-lg p-10" bind:this={element}></div>
...
<style>
	...
	:global(.__ED-ROOT [loading='true']) {
		@apply border-accent relative border-8;
	}
	:global(.__ED-ROOT [loading='true']::before) {
		@apply bg-background/70 text-foreground absolute top-0 right-0 bottom-0 left-0 flex items-center justify-center text-2xl;
